...
- **Review passes.** Name your own editing passes — Structural, Line, Copyedit, Proof, to start — and track where every piece stands with a board (Review persona), a triaged queue, and ⌘R rounds that report the distance travelled since the last one.
