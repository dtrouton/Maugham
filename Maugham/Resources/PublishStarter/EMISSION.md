...
\providecommand{\scenenumber}[1]{\hfill #1}
\providecommand{\screenplaytitleblock}[2]{\begin{center}\vspace*{1.5in}#1#2\end{center}\clearpage}
\screenplaytitleblock{{\Large\textbf{The Play}}\par\vspace{1.5em}}{A. Writer\par}
\scene{INT. HOUSE - DAY}
\action{Action.}
\end{screenplay}
```
