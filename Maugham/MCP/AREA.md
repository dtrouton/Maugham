...
- `find_references` — wiki-link back-references to a document or research item; scans both manuscript documents and research note bodies (canvas promotion writes `[[…]]` into research notes)
