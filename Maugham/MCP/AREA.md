...
It exists for **Claude Code**, not Claude Desktop, and is not part of the production 57-tool
count above — the "Tool catalogue (57)" heading is unaffected by these tools.
