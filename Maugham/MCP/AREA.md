...
It exists for **Claude Code**, not Claude Desktop, and is not part of the production 59-tool
count above — the "Tool catalogue (59)" heading is unaffected by these tools.
