...
10. **Op-log append framing** (length/checksum per line) closing 0.6's valid-JSON-torn-line case — pairs naturally with the compaction ADR whenever that work starts. (M)
