...
public struct InboxEntry: Codable, Equatable, Sendable, Identifiable {
    ...
    public enum Kind: String, Codable, Equatable, Sendable {
        ...
        /// Cross-version forward-tolerance (ADR 0014): an unknown `kind` from a
    ...
    public enum TranscriptionState: String, Codable, Equatable, Sendable {
        ...
        /// Cross-version forward-tolerance (ADR 0014): an unknown state decodes
    ...
    public enum Status: String, Codable, Equatable, Sendable {
        ...
        /// Cross-version forward-tolerance (ADR 0014): an unknown status decodes
