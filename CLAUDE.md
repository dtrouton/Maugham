...
| 22 | Key a Document-binding reload on the doc's PATH, not its id | An id-keyed reload survives a rename and shows stale content; hit twice — once in the editor husk-reload fix, once in the palette rename-revert instance (E2) | Canonical: `EditorHost.needsReload` |
